...
"""``ros2 plansys2 plan_monitor`` verb."""
...
from ..controller.ros_controllers import PlanMonitorProcessor


class PlanMonitorVerb(VerbExtension):
    """Monitor the executing plan and action execution info."""
    ...
    def main(self, *, args):
        with NodeStrategy(args) as node:
            try:
                _sub = PlanMonitorProcessor(node, self._callback)
